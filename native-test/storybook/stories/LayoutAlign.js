...
import { Layout, Section } from '../setup'
...
storiesOf('Layout Alignment Horizontal', module)
  .add('default', () => <LayoutAlignment horizontal onPress={() => console.log('hi')} />)
...
storiesOf('Layout Alignment Horizontal Grow', module)
...
storiesOf('Layout Alignment Vertical', module)
...
storiesOf('Layout Alignment Vertical Grow', module)
